...
<body>
    <nav class="navbar navbar-expand-lg navbar-dark bg-dark">
      ...
      <div class="box">
          <div class="box1">Login as a Car Rental Agency</div>
          <div class="box2">
          <form action="agency_login_process.php" method="post">
                    <h1 style="color: brown;font-weight: bold"> Login</h1>
                    <div class="form-group my-3">
                      <input type="email" class="form-control" placeholder="Company Email" name="C_Email" required>
                    </div>
                    <div class="form-group my-3">
                      <input type="password" id="typepass"class="form-control" placeholder="Company Password" name="C_Password" required>
                    </div>
                    <input type="submit" value="Sign in" name="submit2"class="btn btn-primiary btn-danger">
                    <input type="reset" value="Reset" class="btn btn-danger">
          </form>
          </div>
          <div class="box3">Login as a Customer :- <a href="login_user.php"> Login</a></div>
      </div>
</body>
</html>